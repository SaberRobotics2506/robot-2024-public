...
public class PoseEstimator extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SwerveModulePosition[] modulePoses = swerveSubsystem.getPositions(true);
  ...
  {
    driftEstimator.resetPosition(pigeon2Subsystem.getGyroRotation(true), swerveSubsystem.getPositions(true), pose);
  }
