...
public class SwerveModule {
    ...
    private void configDriveMotor() {
        ...
        talongfxConfigs.CurrentLimits.StatorCurrentLimit = ModuleConstants.driveStatorCurrentLimit;
        talongfxConfigs.CurrentLimits.StatorCurrentLimitEnable = ModuleConstants.driveStatorCurrentLimitEnabled;
        ...
        talongfxConfigs.MotorOutput.NeutralMode = NeutralModeValue.Brake;
